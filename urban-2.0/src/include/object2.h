...
public:
    ...
    ElevatorStation_o(const ElevatorStation_o&) = delete;
    ElevatorStation_o& operator=(const ElevatorStation_o&) = delete;
...
public:
    ...
    int update();
    virtual ~Elevator_o();
    Elevator_o(const Elevator_o&) = delete;
    Elevator_o& operator=(const Elevator_o&) = delete;
...
public:
    ...
    ElevatorWire_o(const ElevatorWire_o&) = delete;
    ElevatorWire_o& operator=(const ElevatorWire_o&) = delete;
...
public:
    ...
    int update();
    virtual ~Tank_o();
    Tank_o(const Tank_o&) = delete;
    Tank_o& operator=(const Tank_o&) = delete;
